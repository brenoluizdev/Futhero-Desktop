  ...
  function createHomePage() {
    ...
    ">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px; margin-top: 24px;">
        ...
        <div style="background: #2f3136; padding: 24px; border-radius: 8px; border-left: 4px solid #764ba2;">
          <h3 style="color: #fff; font-family: 'Segoe UI', Arial, sans-serif; font-size: 18px; margin: 0 0 12px 0;">
            🛡️ AntiCheat Integrado
          </h3>
          <p style="color: #b9bbbe; font-family: 'Segoe UI', Arial, sans-serif; font-size: 14px; margin: 0; line-height: 1.5;">
            Sistema de proteção avançado para gameplay justo
          </p>
        </div>
  ...
  function createSettingsPage() {
    ...
    page.innerHTML = `
      ...
      <div style="background: #2f3136; padding: 24px; border-radius: 8px; margin-bottom: 16px;">
        ...
        <p style="color: #b9bbbe; font-family: 'Segoe UI', Arial, sans-serif; font-size: 14px; margin: 0 0 16px 0; line-height: 1.6;">
          Sistema de proteção ativo e monitorando o jogo
        </p>
        <div style="color: #43b581; font-family: 'Segoe UI', Arial, sans-serif; font-size: 14px;">
          ✓ Proteção de Memória Ativa<br>
          ✓ Detecção de Speed Hack Ativa<br>
          ✓ Validação de Pacotes Ativa
        </div>
      </div>
